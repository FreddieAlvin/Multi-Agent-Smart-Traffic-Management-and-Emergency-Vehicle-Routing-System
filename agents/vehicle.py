...
class VehicleAgent(agent.Agent):
    ...
    async def _wait_for_green(self, from_pos, to_pos):
        """
        Block until the traffic light at 'to_pos' grants passage for movement
        from from_pos -> to_pos. If there is no traffic light at 'to_pos',
        returns immediately.
        """
        ...
        while True:
            ...
            print(
                f"[{self.label}] 📩 Traffic light reply: "
